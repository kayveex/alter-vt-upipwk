...
<body class="vh-100 overflow-hidden">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="informasiSide"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Ruang Administrasi UPI Purwakarta</h5>
        ...
        <div class="offcanvas-body">
            <p class="canvas-para">Ruang administrasi merupakan ruang bagi pegawai untuk memberikan pelayanan
                ...
                printer, PC, tempat penyimpanan dokumen. Melalui ruang ini informasi akademik dan surat menyurat.
            </p>
        </div>
    </div>
    {{-- Foto 360 nya --}}
